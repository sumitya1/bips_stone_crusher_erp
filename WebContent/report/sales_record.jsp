...
<td><label>STONE_TYPE</label></td>
<td><label>DATE<label></td>
<td><label>RATE</label></td>
<td><label>QUANTITY</label></td>
<td><label>NO_OF_TRUCKS</label></td>
...
<tr class="success">
<td><%=records.get(i).getStone_type() %></td>
<td><%=records.get(i).getSystemdate() %></td>
<td><%=records.get(i).getRate() %></td>
<td><%=records.get(i).getQuantity() %></td>
<td><%=records.get(i).getNo_of_trucks()%></td>
<td><%=records.get(i).getCompany_name() %></td>
